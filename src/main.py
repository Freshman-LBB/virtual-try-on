...
if __name__ == "__main__":
    ...
    json_path = os.path.join(PROJECT_ROOT, 'data/final_combined_pairs.json')
    ...
    cloth_path = os.path.join(PROJECT_ROOT, 'data/raw_images/clothes', cloth_filename)
    human_path = os.path.join(PROJECT_ROOT, 'data/raw_images/humans', human_filename)
